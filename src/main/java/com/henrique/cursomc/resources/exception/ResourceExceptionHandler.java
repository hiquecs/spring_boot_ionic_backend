...
import com.henrique.cursomc.services.Exceptions.AuthorizationException;
import com.henrique.cursomc.services.Exceptions.DataIntegrityException;
import com.henrique.cursomc.services.Exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> amazonS3(AmazonS3Exception e, HttpServletRequest request) {
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Error SF3",
				e.getMessage(), request.getRequestURI());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
	}
}
